...
const AdminUsers = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsuarios = async () => {
      try {
        ...
        const response = await axios.get(`https://musica-store.vercel.app/usuarios?page=${currentPage}`, {
  ...
  const handleDelete = async (userId) => {
    ...
    try {
        ...
        await axios.patch(`https://musica-store.vercel.app/eliminarUsuario/${userId}`, {}, {
            headers: { 
                Authorization: `Bearer ${token}`,
            },
        });
