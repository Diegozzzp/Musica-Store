...
const URL_PRODUCTOS = 'https://https://musica-store-production.up.railway.app/productos/categoria/';
...
const CarruselProductos = ({ categoriaId, titulo }) => {
    ...
    const fixImagePath = path => `https://https://musica-store-production.up.railway.app/uploads/${path.replace(/\\/g, '/')}`;
