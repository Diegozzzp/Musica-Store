    ...
    useEffect(() => {
        const fetchReportes = async () => {
            try {
                ...
                const urls = {
                    diario: `https://musica-store.vercel.app/ventas-diarias?fecha=${todayString}`,
                    semanal: `https://musica-store.vercel.app/ventas-semanales?fecha=${todayString}`,
                    anual: `https://musica-store.vercel.app/ventas-anuales?año=${year}`,
                    masVendidos: `https://musica-store.vercel.app/productos-mas-vendidos`,
                    menosVendidos: `https://musica-store.vercel.app/productos-menos-vendidos`
                };
