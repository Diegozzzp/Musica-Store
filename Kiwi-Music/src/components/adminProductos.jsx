...
const AdminProductos = () => {
    ...
    const fetchProductos = async () => {
        try {
            ...
            const response = await axios.get(`https://musica-store.vercel.app/productos?page=${currentPage}`, {
    ...
    const handleSave = async (productId, formData) => {
        try {
            ...
            const response = await axios.patch(
                `https://musica-store.vercel.app/productos/${productId}`,
                formData,
                {
                    headers: { 
    ...
    const handleCreateProduct = async (formData) => {
        try {
            await axios.post('https://musica-store.vercel.app/productos', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
    ...
    const handleDelete = async (productId) => {
        ...
        try {
            ...
            await axios.delete(`https://musica-store.vercel.app/productos/${productId}`, {}, {
                headers: { Authorization: `Bearer ${token}` },
            });
